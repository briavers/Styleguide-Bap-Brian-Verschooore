...
gulp.task('copy', function() {
	...
	var metaStream = gulp.src(['development/meta/*icon*.*', 'development/meta/manifest.json'])
		.pipe(plumber())
		.pipe(gulp.dest(process.env.deployLocation + '/meta'));
	...
	return merge(htaccessStream, browserConfigStream, metaStream, vendorScriptsStream, fontsStream);
